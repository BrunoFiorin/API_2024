...
function calcular(){
    var retangulo = {altura: document.getElementById("txtValor1").value, largura: document.getElementById("txtValor2").value,

        calcularArea : function(){
            soma = parseFloat(this.altura) * parseFloat(this.largura);
            texto = "Área: " + soma;
            return texto;      
        }};
    
        resp = document.getElementById("resp");
        resp.innerHTML = retangulo.calcularArea();
